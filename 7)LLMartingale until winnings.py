...
def winningplay(gains,i,bet,gains2,earnings,loss,minn,j,betlimit,winnings,games,mins):
    gains += i*bet
    gains2 += i*bet
    earnings += i*bet
    if i > 0:
    ...
    if gains2 > winnings:
        ...
        mins.append(minn)
        minn = 0
    return gains,bet,gains2,earnings,loss,minn,games,mins
...
for winnings in limits:
    ...
    for i in bjgenerate(total_games):
        ...
        gains1 += i*bet1
        gains11 += i*bet1
        bet1,earnings1,loss1 = bs.llmartingale(i,bet1,earnings1,loss1)
        if earnings1 < min1:
            min1 = earnings1
        if bet1 > betlimit:
            bet1 ,gains1 = 1 , 0      
        ...
        gains2,bet2,gains22,earnings2,loss2,min2,games2,mins2 = winningplay(gains2,i,bet2,gains22,earnings2,loss2,min2,j2,betlimit,winnings,games2,mins2)
        gains3,bet3,gains33,earnings3,loss3,min3,games3,mins3 = winningplay(gains3,i,bet3,gains33,earnings3,loss3,min3,j3,betlimit,winnings,games3,mins3)
        gains4,bet4,gains44,earnings4,loss4,min4,games4,mins4 = winningplay(gains4,i,bet4,gains44,earnings4,loss4,min4,j4,betlimit,winnings,games4,mins4)
