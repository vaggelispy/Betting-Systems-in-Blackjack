...
def winlimitim(i,bet,earnings,win,gains,j):
    gains += i*bet   
    earnings += i*bet
    if i > 0:
        win += i*bet
...
for j in range(repeats): 
    ...
    while a < -0.9712 or a > 0:
        ...
        for i in bjgenerate(total_games):
            ...
            bet1,earnings1,loss1,gains1 = winlimitim(i,bet1,earnings1,loss1,gains1,j1)
            if bet1 > betlimit:
                bet1 ,gains1 = 1 , 0
            data1.append(earnings1)
            
            bet2,earnings2,loss2,gains2 = winlimitim(i,bet2,earnings2,loss2,gains2,j2)
            if bet2 > betlimit:
                bet2 ,gains2 = 1 , 0
            data2.append(earnings2)
            
            bet3,earnings3,loss3,gains3 = winlimitim(i,bet3,earnings3,loss3,gains3,j3)
            if bet3 > betlimit:
                bet3 ,gains3 = 1 , 0
            data3.append(earnings3)
            
            bet4,earnings4,loss4,gains4 = winlimitim(i,bet4,earnings4,loss4,gains4,j4)
            if bet4 > betlimit:
                bet4 ,gains4 = 1 , 0
            data4.append(earnings4)
            
            bet5,earnings5,loss5,gains5 = winlimitim(i,bet5,earnings5,loss5,gains5,j5)
            if bet5 > betlimit:
                bet5 ,gains5 = 1 , 0
            data5.append(earnings5)
            
            bet6,earnings6,loss6,gains6 = winlimitim(i,bet6,earnings6,loss6,gains6,j6)
            if bet6 > betlimit:
                bet6 ,gains6 = 1 , 0
            data6.append(earnings6)
            
            bet7,earnings7,loss7,gains7 = winlimitim(i,bet7,earnings7,loss7,gains7,j7)
            if bet7 > betlimit:
                bet7 ,gains7 = 1 , 0
            data7.append(earnings7)
            
            bet8,earnings8,loss8,gains8 = winlimitim(i,bet8,earnings8,loss8,gains8,j8)
            if bet8 > betlimit:
                bet8 ,gains8 = 1 , 0
            data8.append(earnings8)
            
            bet9,earnings9,loss9,gains9 = winlimitim(i,bet9,earnings9,loss9,gains9,j9)
            if bet9 > betlimit:
                bet9 ,gains9 = 1 , 0
            data9.append(earnings9)
            
            bet0,earnings0,loss0,gains0 = winlimitim(i,bet0,earnings0,loss0,gains0,j0)
            if bet0 > betlimit:
                bet0 ,gains0 = 1 , 0
