...
def losslimitim(i,bet,earnings,gains,j):
    gains += i*bet 
    earnings += i*bet
    if i > 0:
        if bet <= 1:
...
j1 , j2 , j3 , j4 , j5 , j6 , j7 , j8 , j9 , j0 = 5 , 10 , 15 , 20 , 25 , 30 , 40 , 50 , 75 , 100
limits = [j1,j2,j3,j4,j5,j6,j7,j8,j9,j0]
ends1 , ends2 , ends3 , ends4 , ends5 , ends6 , ends7 , ends8 , ends9 , ends0 = [] , [] , [] , [] , [] , [] , [] , [] , [] , [] 
mins1 , mins2 , mins3 , mins4 , mins5 , mins6 , mins7 , mins8 , mins9 , mins0 = [] , [] , [] , [] , [] , [] , [] , [] , [] , []
maxs1 , maxs2 ,maxs3 , maxs4 , maxs5 , maxs6 , maxs7 , maxs8 , maxs9 , maxs0 = [] , [] , [] , [] , [] , [] , [] , [] , [] , []
 
for j in range(repeats): 
    a = 0.4856
    while a < -0.9712 or a > 0:
        
        bet1 , earnings1 , data1 , gains1 = 1 , 0 , [] , 0
        bet2 , earnings2 , data2 , gains2 = 1 , 0 , [] , 0
        bet3 , earnings3 , data3 , gains3 = 1 , 0 , [] , 0
        bet4 , earnings4 , data4 , gains4 = 1 , 0 , [] , 0
        bet5 , earnings5 , data5 , gains5 = 1 , 0 , [] , 0
        bet6 , earnings6 , data6 , gains6 = 1 , 0 , [] , 0
        bet7 , earnings7 , data7 , gains7 = 1 , 0 , [] , 0
        bet8 , earnings8 , data8 , gains8 = 1 , 0 , [] , 0
        bet9 , earnings9 , data9 , gains9 = 1 , 0 , [] , 0
        bet0 , earnings0 , data0 , gains0 = 1 , 0 , [] , 0
        datam = []
                
        for i in bjgenerate(total_games):
                        
            bet1,earnings1,gains1 = losslimitim(i,bet1,earnings1,gains1,j1)
            if bet1 > betlimit:
                bet1 ,gains1 = 1 , 0
            data1.append(earnings1)
            
            bet2,earnings2,gains2 = losslimitim(i,bet2,earnings2,gains2,j2)
            if bet2 > betlimit:
                bet2 ,gains2 = 1 , 0
            data2.append(earnings2)
            
            bet3,earnings3,gains3 = losslimitim(i,bet3,earnings3,gains3,j3)
            if bet3 > betlimit:
                bet3 ,gains3 = 1 , 0
            data3.append(earnings3)
            
            bet4,earnings4,gains4 = losslimitim(i,bet4,earnings4,gains4,j4)
            if bet4 > betlimit:
                bet4 ,gains4 = 1 , 0
            data4.append(earnings4)
            
            bet5,earnings5,gains5 = losslimitim(i,bet5,earnings5,gains5,j5)
            if bet5 > betlimit:
                bet5 ,gains5 = 1 , 0
            data5.append(earnings5)
            
            bet6,earnings6,gains6 = losslimitim(i,bet6,earnings6,gains6,j6)
            if bet6 > betlimit:
                bet6 ,gains6 = 1 , 0
            data6.append(earnings6)
            
            bet7,earnings7,gains7 = losslimitim(i,bet7,earnings7,gains7,j7)
            if bet7 > betlimit:
                bet7 ,gains7 = 1 , 0
            data7.append(earnings7)
            
            bet8,earnings8,gains8 = losslimitim(i,bet8,earnings8,gains8,j8)
            if bet8 > betlimit:
                bet8 ,gains8 = 1 , 0
            data8.append(earnings8)
            
            bet9,earnings9,gains9 = losslimitim(i,bet9,earnings9,gains9,j9)
            if bet9 > betlimit:
                bet9 ,gains9 = 1 , 0
            data9.append(earnings9)
            
            bet0,earnings0,gains0 = losslimitim(i,bet0,earnings0,gains0,j0)
            if bet0 > betlimit:
                bet0 ,gains0 = 1 , 0
    ...
    plt.plot(limits,endsplot,'b-',alpha=0.2)  
plt.title('All end ups - Bet limits')
plt.show()
